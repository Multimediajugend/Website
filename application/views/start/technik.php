<div class="wrapper">
    ...
    <div class="grid oneFifth">
        ...
        <ul class="memberList">
            <li class="memberEntry"><a href="#"><i class="fa fa-download fa-fw"></i> Clanwars XI</a></li>
            <li class="memberEntry"><a href="#"><i class="fa fa-download fa-fw"></i> Chemnitz zockt</a></li>
            <li class="memberEntry"><a href="#"><i class="fa fa-download fa-fw"></i> BOINC</a></li>
        </ul>
    </div>
</div>